      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div 
            ...
            className="relative w-full aspect-square max-w-md mx-auto lg:max-w-none lg:aspect-auto lg:h-[500px] bg-white border border-gray-100 rounded-[3rem] p-8 overflow-hidden shadow-lg"
          >
            {/* Map background grid */}
