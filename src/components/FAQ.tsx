...
const faqs = [
  ...
  { q: "Is there a registration fee?", a: "No, registration is completely free. There are no hidden fees or upfront costs to join SwiftKeke as a driver." },
    ...
    <section id="faq" className="py-24 lg:py-32 relative">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Everything you need to know before signing up.</p>
        </div>
          ...
          {faqs.map(({ q, a }, i) => (
            <div
              ...
              className={`border rounded-2xl overflow-hidden transition-all duration-300 ${
                open === i ? "bg-purple-700/10 border-purple-500/30" : "bg-white/[0.02] border-white/[0.06] hover:border-purple-500/20"
              }`}
            >
              <button
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 text-purple-400 shrink-0 transition-transform duration-300 ${open === i ? "rotate-180" : ""}`} />
              </button>
